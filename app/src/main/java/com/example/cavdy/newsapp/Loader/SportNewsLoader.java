...
public class SportNewsLoader extends AsyncTaskLoader<List<News>>{
    public SportNewsLoader(@NonNull Context context) {
        super(context);
    }
    ...
    public List<News> loadInBackground() {
        ...
        try {
            URL url = SportQueryUtils.createUrl();
            String jsonResponse = SportQueryUtils.makeHttpRequest(url);
            newsList = SportQueryUtils.extractFeatureFromJson(jsonResponse);
        } catch (IOException e) {
