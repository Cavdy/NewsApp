...
public class ForeignnewsRecyclerviewAdapter extends RecyclerView.Adapter<ForeignnewsRecyclerviewAdapter.MyViewHolder> {

    private Context mContext;
    private List<News> mData;

    public ForeignnewsRecyclerviewAdapter(Context mContext, List<News> mData) {
