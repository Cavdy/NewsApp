    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                String authorName = properties.getString("type");
                String titlePost = properties.getString("webTitle");
                String time = properties.getString("sectionName");
                String url = properties.getString("webUrl");

                News news1 = new News(titlePost, authorName, url, time);
                news.add(news1);
            }
