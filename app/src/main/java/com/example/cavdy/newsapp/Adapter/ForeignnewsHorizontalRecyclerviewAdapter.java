...
public class ForeignnewsHorizontalRecyclerviewAdapter extends RecyclerView.Adapter<ForeignnewsHorizontalRecyclerviewAdapter.MyViewHolder> {

    private Context mContext;
    private List<News> mData;

    public ForeignnewsHorizontalRecyclerviewAdapter(Context mContext, List<News> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = mInflater.inflate(R.layout.foreignnews_horizontal_layout, viewGroup, false);
